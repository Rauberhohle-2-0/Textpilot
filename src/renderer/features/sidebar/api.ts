...
export async function moveFolder(id: string, parentId: string | null, position: number): Promise<FolderMeta> {
...
export async function moveDocument(id: string, parentId: string | null, position: number): Promise<void> {
